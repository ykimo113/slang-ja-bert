...
<img width="1103" alt="単語ベクトルの変化図" src="https://github.com/ykimo113/slangBert/assets/153272953/10d7acb9-a422-421f-a94a-1dc95a3acfa4">
* 追加学習前は「未知語である」ことを示す単語ベクトルから、追加学習後は「音楽分野の単語である」ことを示す単語ベクトルへ変化している

### 感情分析タスクの性能比較
* 追加学習を適用したモデルとしなかったモデルで同じ学習回数でファインチューニングを行い、比較・評価を行う
* 学習損失、評価損失、精度、macro-F1スコアを評価指標として利用
* 各ラベルに対して正しくラベル付けが行われた割合を評価する

* 各評価指標の比較
<img width="1310" alt="感情分析精度の変化図" src="https://github.com/ykimo113/slangBert/assets/153272953/e648df8a-30d0-48b5-8110-125190a2b8a7">
* 全ての評価指標において提案手法のモデルで改善が見られた

* 各ラベルに対する正解率
![confusionmatrix](https://github.com/ykimo113/slangBert/assets/153272953/999c6ba7-ea11-4307-b5b0-18e0e22d4da3)
* 全てのラベルにおいて正しくラベル付けできた割合が最も高かった
* NEGATIVEラベルは他ラベルと比較して誤ったラベルが付与される割合が高かった
→ データセットの偏りによる影響
